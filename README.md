...
## Installation
```bash
$ curl -sL http://mavenrepo.dbc.dk/content/repositories/releases/dk/dbc/rawrepo-dump-tool/1.0.3/rawrepo-dump-tool-1.0.3.jar -o rrdump.jar && unzip -op rrdump.jar rrdump.sh | bash -s -- --install
